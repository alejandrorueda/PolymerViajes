...
/**
 * Base class that represents a row from the 'miembros_grupo' table.
 *
 * 
 *
 * @package    propel.generator..Base
 */
abstract class MiembrosGrupo implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\MiembrosGrupoTableMap';
    ...
    /**
     * Initializes internal state of Base\MiembrosGrupo object.
     */
    ...
    /**
     * Compares this with another <code>MiembrosGrupo</code> instance.  If
     * <code>obj</code> is an instance of <code>MiembrosGrupo</code>, delegates to
     * <code>equals(MiembrosGrupo)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|MiembrosGrupo The current object, for fluid interface
     */
     ...
     * @return $this|\MiembrosGrupo The current object (for fluent API support)
     */
    public function setIdgrupo($v)
    {
        ...
        if ($this->idgrupo !== $v) {
            $this->idgrupo = $v;
            $this->modifiedColumns[MiembrosGrupoTableMap::COL_IDGRUPO] = true;
        }
    ...
    public function setIdusuario($v)
    {
        ...
        if ($this->idusuario !== $v) {
            $this->idusuario = $v;
            $this->modifiedColumns[MiembrosGrupoTableMap::COL_IDUSUARIO] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : MiembrosGrupoTableMap::translateFieldName('Idgrupo', TableMap::TYPE_PHPNAME, $indexType)];
            $this->idgrupo = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : MiembrosGrupoTableMap::translateFieldName('Idusuario', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = MiembrosGrupoTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\MiembrosGrupo'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildMiembrosGrupoQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see MiembrosGrupo::setDeleted()
     * @see MiembrosGrupo::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildMiembrosGrupoQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MiembrosGrupoTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(MiembrosGrupoTableMap::COL_IDGRUPO)) {
            $modifiedColumns[':p' . $index++]  = 'idgrupo';
        }
        if ($this->isColumnModified(MiembrosGrupoTableMap::COL_IDUSUARIO)) {
            $modifiedColumns[':p' . $index++]  = 'idusuario';
        }

        $sql = sprintf(
            'INSERT INTO miembros_grupo (%s) VALUES (%s)',
    ...
    {
        $pos = MiembrosGrupoTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['MiembrosGrupo'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['MiembrosGrupo'][$this->hashCode()] = true;
        $keys = MiembrosGrupoTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MiembrosGrupoTableMap::COL_IDGRUPO)) {
            $criteria->add(MiembrosGrupoTableMap::COL_IDGRUPO, $this->idgrupo);
        }
        if ($this->isColumnModified(MiembrosGrupoTableMap::COL_IDUSUARIO)) {
            $criteria->add(MiembrosGrupoTableMap::COL_IDUSUARIO, $this->idusuario);
        }
    ...
    {
        $criteria = ChildMiembrosGrupoQuery::create();
        $criteria->add(MiembrosGrupoTableMap::COL_IDGRUPO, $this->idgrupo);
        $criteria->add(MiembrosGrupoTableMap::COL_IDUSUARIO, $this->idusuario);
    ...
    public function hashCode()
    {
        ...
        //relation miembros_grupo_fk_4e8c68 to table grupo
        ...
        //relation miembros_grupo_fk_04eafb to table usuario
    ...
    {
        return (null === $this->getIdgrupo()) && (null === $this->getIdusuario());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \MiembrosGrupo (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \MiembrosGrupo Clone of current object.
     * @throws PropelException
     */
    ...
    public function getGrupo(ConnectionInterface $con = null)
    {
        if ($this->aGrupo === null && ($this->idgrupo !== null)) {
            $this->aGrupo = ChildGrupoQuery::create()
                ->filterByMiembrosGrupo($this) // here
                ->findOne($con);
            /* The following can be used additionally to
                ...
                $this->aGrupo->addMiembrosGrupos($this);
             */
        }
    ...
    public function getUsuario(ConnectionInterface $con = null)
    {
        if ($this->aUsuario === null && (($this->idusuario !== "" && $this->idusuario !== null))) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUsuario->addMiembrosGrupos($this);
             */
        }
    ...
    {
        if (null !== $this->aGrupo) {
            $this->aGrupo->removeMiembrosGrupo($this);
        }
        if (null !== $this->aUsuario) {
            $this->aUsuario->removeMiembrosGrupo($this);
        }
        $this->idgrupo = null;
        $this->idusuario = null;
        $this->alreadyInSave = false;
    ...
    {
        return (string) $this->exportTo(MiembrosGrupoTableMap::DEFAULT_STRING_FORMAT);
    }
