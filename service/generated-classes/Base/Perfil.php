...
abstract class Perfil implements ActiveRecordInterface 
{
    ...
    /**
     * The value for the tipo_favorito field.
     * 
     * @var        int
     */
    protected $tipo_favorito;

    protected $tipo_favorito_converted;
    ...
    /**
     * The value for the destinos field.
     * 
     * @var        int
     */
    protected $destinos;

    protected $destinos_converted;
    ...
    /**
     * Get the [tipo_favorito] column value.
     * 
     * @return array|null
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function getTipoFavorito()
    {
        if (null === $this->tipo_favorito_converted) {
            $this->tipo_favorito_converted = array();
        }
        if (!$this->tipo_favorito_converted && null !== $this->tipo_favorito) {
            $valueSet = PerfilTableMap::getValueSet(PerfilTableMap::COL_TIPO_FAVORITO);
            try {
                $this->tipo_favorito_converted = SetColumnConverter::convertIntToArray($this->tipo_favorito, $valueSet);
            } catch (SetColumnConverterException $e) {
                throw new PropelException('Unknown stored set key: ' . $e->getValue(), $e->getCode(), $e);
            }
        }
        
        return $this->tipo_favorito_converted;
    }
    ...
    {
        if (null === $this->gustos_converted) {
            $this->gustos_converted = array();
        }
        if (!$this->gustos_converted && null !== $this->gustos) {
            $valueSet = PerfilTableMap::getValueSet(PerfilTableMap::COL_GUSTOS);
            try {
                $this->gustos_converted = SetColumnConverter::convertIntToArray($this->gustos, $valueSet);
            } catch (SetColumnConverterException $e) {
                throw new PropelException('Unknown stored set key: ' . $e->getValue(), $e->getCode(), $e);
            }
        }
        
        return $this->gustos_converted;
    }

    /**
     * Test the presence of a value in the [gustos] set column value.
     * @param      mixed $value
     * 
     * @return boolean
     */
    public function hasGusto($value)
    {
        return in_array($value, $this->getGustos());
    } // hasGusto()
    ...
    {
        if (null === $this->destinos_converted) {
            $this->destinos_converted = array();
        }
        if (!$this->destinos_converted && null !== $this->destinos) {
            $valueSet = PerfilTableMap::getValueSet(PerfilTableMap::COL_DESTINOS);
            try {
                $this->destinos_converted = SetColumnConverter::convertIntToArray($this->destinos, $valueSet);
            } catch (SetColumnConverterException $e) {
                throw new PropelException('Unknown stored set key: ' . $e->getValue(), $e->getCode(), $e);
            }
        }
        
        return $this->destinos_converted;
    }

    /**
     * Test the presence of a value in the [destinos] set column value.
     * @param      mixed $value
     * 
     * @return boolean
     */
    public function hasDestino($value)
    {
        return in_array($value, $this->getDestinos());
    } // hasDestino()
    ...
    public function setDescripcion($v)
    {
        ...
        if ($this->descripcion !== $v) {
            $this->descripcion = $v;
            $this->modifiedColumns[PerfilTableMap::COL_DESCRIPCION] = true;
        }
    ...
    /**
     * Set the value of [tipo_favorito] column.
     * 
     * @param  array $v new value
     * @return $this|\Perfil The current object (for fluent API support)
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function setTipoFavorito($v)
    {
        if ($this->tipo_favorito_converted === null || count(array_diff($this->tipo_favorito_converted, $v)) > 0 || count(array_diff($v, $this->tipo_favorito_converted)) > 0) {
            $valueSet = PerfilTableMap::getValueSet(PerfilTableMap::COL_TIPO_FAVORITO);
            try {
            ...
            if ($this->tipo_favorito !== $v) {
                $this->tipo_favorito_converted = null;
                $this->tipo_favorito = $v;
                $this->modifiedColumns[PerfilTableMap::COL_TIPO_FAVORITO] = true;
            }
        }
    ...
    {
        if ($this->gustos_converted === null || count(array_diff($this->gustos_converted, $v)) > 0 || count(array_diff($v, $this->gustos_converted)) > 0) {
            $valueSet = PerfilTableMap::getValueSet(PerfilTableMap::COL_GUSTOS);
            try {
                $v = SetColumnConverter::convertToInt($v, $valueSet);
            } catch (SetColumnConverterException $e) {
    ...
    /**
     * Adds a value to the [gustos] set column value.
     * @param  mixed $value
     * 
     * @return $this|\Perfil The current object (for fluent API support)
     */
    public function addGusto($value)
    {
        $currentArray = $this->getGustos();
        $currentArray []= $value;
        $this->setGustos($currentArray);

        return $this;
    } // addGusto()

    /**
     * Removes a value from the [gustos] set column value.
     * @param  mixed $value
     * 
     * @return $this|\Perfil The current object (for fluent API support)
     */
    public function removeGusto($value)
    {
        $targetArray = array();
        foreach ($this->getGustos() as $element) {
            if ($element != $value) {
                $targetArray []= $element;
            }
        }
        $this->setGustos($targetArray);
    ...
    /**
     * Set the value of [destinos] column.
     * 
     * @param  array $v new value
     * @return $this|\Perfil The current object (for fluent API support)
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function setDestinos($v)
    {
        if ($this->destinos_converted === null || count(array_diff($this->destinos_converted, $v)) > 0 || count(array_diff($v, $this->destinos_converted)) > 0) {
            $valueSet = PerfilTableMap::getValueSet(PerfilTableMap::COL_DESTINOS);
            try {
                $v = SetColumnConverter::convertToInt($v, $valueSet);
            } catch (SetColumnConverterException $e) {
            ...
            if ($this->destinos !== $v) {
                $this->destinos_converted = null;
                $this->destinos = $v;
                $this->modifiedColumns[PerfilTableMap::COL_DESTINOS] = true;
            }
        }
    ...
    /**
     * Adds a value to the [destinos] set column value.
     * @param  mixed $value
     * 
     * @return $this|\Perfil The current object (for fluent API support)
     */
    public function addDestino($value)
    {
        $currentArray = $this->getDestinos();
        $currentArray []= $value;
        $this->setDestinos($currentArray);

        return $this;
    } // addDestino()

    /**
     * Removes a value from the [destinos] set column value.
     * @param  mixed $value
     * 
     * @return $this|\Perfil The current object (for fluent API support)
     */
    public function removeDestino($value)
    {
        $targetArray = array();
        foreach ($this->getDestinos() as $element) {
            if ($element != $value) {
                $targetArray []= $element;
            }
        }
        $this->setDestinos($targetArray);
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PerfilTableMap::translateFieldName('Descripcion', TableMap::TYPE_PHPNAME, $indexType)];
            $this->descripcion = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PerfilTableMap::translateFieldName('TipoFavorito', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tipo_favorito = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : PerfilTableMap::translateFieldName('Gustos', TableMap::TYPE_PHPNAME, $indexType)];
            $this->gustos = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : PerfilTableMap::translateFieldName('Nacimiento', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->nacimiento = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : PerfilTableMap::translateFieldName('Destinos', TableMap::TYPE_PHPNAME, $indexType)];
            $this->destinos = (null !== $col) ? (int) $col : null;
            $this->resetModified();
            ...
            return $startcol + 6; // 6 = PerfilTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PerfilTableMap::COL_DESCRIPCION)) {
            $modifiedColumns[':p' . $index++]  = 'descripcion';
        }
        if ($this->isColumnModified(PerfilTableMap::COL_TIPO_FAVORITO)) {
            $modifiedColumns[':p' . $index++]  = 'tipo_favorito';
        }
        ...
        if ($this->isColumnModified(PerfilTableMap::COL_DESTINOS)) {
            $modifiedColumns[':p' . $index++]  = 'destinos';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'descripcion':                        
                        ...
                        break;
                    case 'tipo_favorito':                        
                        $stmt->bindValue($identifier, $this->tipo_favorito, PDO::PARAM_INT);
                        break;
                    case 'gustos':                        
                        $stmt->bindValue($identifier, $this->gustos, PDO::PARAM_INT);
                        break;
                    case 'nacimiento':                        
                        $stmt->bindValue($identifier, $this->nacimiento ? $this->nacimiento->format("Y-m-d H:i:s.u") : null, PDO::PARAM_STR);
                        break;
                    case 'destinos':                        
                        $stmt->bindValue($identifier, $this->destinos, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[2] => $this->getTipoFavorito(),
            $keys[3] => $this->getGustos(),
            $keys[4] => $this->getNacimiento(),
            $keys[5] => $this->getDestinos(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setTipoFavorito($arr[$keys[2]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PerfilTableMap::COL_DESCRIPCION)) {
            $criteria->add(PerfilTableMap::COL_DESCRIPCION, $this->descripcion);
        }
        if ($this->isColumnModified(PerfilTableMap::COL_TIPO_FAVORITO)) {
            $criteria->add(PerfilTableMap::COL_TIPO_FAVORITO, $this->tipo_favorito);
        }
        if ($this->isColumnModified(PerfilTableMap::COL_GUSTOS)) {
        ...
        if ($this->isColumnModified(PerfilTableMap::COL_DESTINOS)) {
            $criteria->add(PerfilTableMap::COL_DESTINOS, $this->destinos);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setTipoFavorito($this->getTipoFavorito());
        $copyObj->setGustos($this->getGustos());
        $copyObj->setNacimiento($this->getNacimiento());
        $copyObj->setDestinos($this->getDestinos());
