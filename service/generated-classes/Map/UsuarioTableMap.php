...
class UsuarioTableMap extends TableMap
{
     ...
     */
    const COL_APELLIDOS = 'usuario.apellidos';

    /**
     * the column name for the avatar field
     */
    const COL_AVATAR = 'usuario.avatar';
     ...
     */
    const COL_IDPERFIL = 'usuario.idperfil';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Idusuario', 'Password', 'Nombre', 'Apellidos', 'Avatar', 'Email', 'Idperfil', ),
        self::TYPE_CAMELNAME     => array('idusuario', 'password', 'nombre', 'apellidos', 'avatar', 'email', 'idperfil', ),
        self::TYPE_COLNAME       => array(UsuarioTableMap::COL_IDUSUARIO, UsuarioTableMap::COL_PASSWORD, UsuarioTableMap::COL_NOMBRE, UsuarioTableMap::COL_APELLIDOS, UsuarioTableMap::COL_AVATAR, UsuarioTableMap::COL_EMAIL, UsuarioTableMap::COL_IDPERFIL, ),
        self::TYPE_FIELDNAME     => array('idusuario', 'password', 'nombre', 'apellidos', 'avatar', 'email', 'idperfil', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Idusuario' => 0, 'Password' => 1, 'Nombre' => 2, 'Apellidos' => 3, 'Avatar' => 4, 'Email' => 5, 'Idperfil' => 6, ),
        self::TYPE_CAMELNAME     => array('idusuario' => 0, 'password' => 1, 'nombre' => 2, 'apellidos' => 3, 'avatar' => 4, 'email' => 5, 'idperfil' => 6, ),
        self::TYPE_COLNAME       => array(UsuarioTableMap::COL_IDUSUARIO => 0, UsuarioTableMap::COL_PASSWORD => 1, UsuarioTableMap::COL_NOMBRE => 2, UsuarioTableMap::COL_APELLIDOS => 3, UsuarioTableMap::COL_AVATAR => 4, UsuarioTableMap::COL_EMAIL => 5, UsuarioTableMap::COL_IDPERFIL => 6, ),
        self::TYPE_FIELDNAME     => array('idusuario' => 0, 'password' => 1, 'nombre' => 2, 'apellidos' => 3, 'avatar' => 4, 'email' => 5, 'idperfil' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('idusuario', 'Idusuario', 'VARCHAR', true, 24, null);
        $this->addColumn('password', 'Password', 'VARCHAR', true, 255, null);
        $this->addColumn('nombre', 'Nombre', 'VARCHAR', true, 24, null);
        $this->addColumn('apellidos', 'Apellidos', 'VARCHAR', true, 24, null);
        $this->addColumn('avatar', 'Avatar', 'VARCHAR', true, 24, null);
        $this->addColumn('email', 'Email', 'VARCHAR', true, 50, null);
        $this->addForeignKey('idperfil', 'Idperfil', 'INTEGER', 'perfil', 'idperfil', true, null, null);
    } // initialize()
  ...
  array (
    ...
    1 => ':idperfil',
        ...
        $this->addRelation('Invitacion', '\\Invitacion', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':idusuario',
    1 => ':idusuario',
  ),
), null, null, 'Invitacions', false);
        $this->addRelation('UsuarioAmigoRelatedByIdusuario', '\\UsuarioAmigo', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':idusuario',
    1 => ':idusuario',
  ),
), null, null, 'UsuarioAmigosRelatedByIdusuario', false);
        $this->addRelation('UsuarioAmigoRelatedByIdamigo', '\\UsuarioAmigo', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':idamigo',
    1 => ':idusuario',
  ),
), null, null, 'UsuarioAmigosRelatedByIdamigo', false);
  ...
  array (
    ...
    1 => ':idusuario',
        ...
        $this->addRelation('ViajeUsuario', '\\ViajeUsuario', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':idusuario',
    1 => ':idusuario',
  ),
), null, null, 'ViajeUsuarios', false);
        $this->addRelation('Mensaje', '\\Mensaje', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':idusuario',
    1 => ':idusuario',
  ),
), null, null, 'Mensajes', false);
        $this->addRelation('UsuarioRelatedByIdamigo', '\\Usuario', RelationMap::MANY_TO_MANY, array(), null, null, 'UsuariosRelatedByIdamigo');
        $this->addRelation('UsuarioRelatedByIdusuario', '\\Usuario', RelationMap::MANY_TO_MANY, array(), null, null, 'UsuariosRelatedByIdusuario');
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UsuarioTableMap::COL_APELLIDOS);
            $criteria->addSelectColumn(UsuarioTableMap::COL_AVATAR);
            $criteria->addSelectColumn(UsuarioTableMap::COL_EMAIL);
            $criteria->addSelectColumn(UsuarioTableMap::COL_IDPERFIL);
        } else {
